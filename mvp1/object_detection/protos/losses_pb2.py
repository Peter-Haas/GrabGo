...
_LOSS_EXPECTEDLOSSWEIGHTS = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="EXPECTED_SAMPLING", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="REWEIGHTING_UNMATCHED_ANCHORS", index=2, number=2, options=None, type=None
        ),
    ],
...
_HARDEXAMPLEMINER_LOSSTYPE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="BOTH", index=0, number=0, options=None, type=None),
        _descriptor.EnumValueDescriptor(
