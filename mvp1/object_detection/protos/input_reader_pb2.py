...
_INSTANCEMASKTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="NUMERICAL_MASKS", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PNG_MASKS", index=2, number=2, options=None, type=None
        ),
    ],
...
_INPUTREADER.fields_by_name["queue_capacity"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\030\001")
)
_INPUTREADER.fields_by_name["min_after_dequeue"].has_options = True
_INPUTREADER.fields_by_name["min_after_dequeue"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\030\001")
)
_INPUTREADER.fields_by_name["prefetch_size"].has_options = True
_INPUTREADER.fields_by_name["prefetch_size"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\030\001")
)
_INPUTREADER.fields_by_name["num_parallel_map_calls"].has_options = True
_INPUTREADER.fields_by_name["num_parallel_map_calls"]._options = _descriptor._ParseOptions(
    descriptor_pb2.FieldOptions(), _b("\030\001")
)
