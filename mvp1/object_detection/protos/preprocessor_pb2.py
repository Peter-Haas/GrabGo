...
_RESIZEIMAGE_METHOD = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name="AREA", index=0, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="BICUBIC", index=1, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name="BILINEAR", index=2, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="NEAREST_NEIGHBOR", index=3, number=4, options=None, type=None
        ),
    ],
