...
_RESIZETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="BICUBIC", index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="AREA", index=3, number=3, options=None, type=None),
    ],
